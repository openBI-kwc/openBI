...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='上传的3D动画表';
...
-- ----------------------------
INSERT INTO `up_attachment` VALUES ('1', 'JPEG,PNG,JPG,SVG,BMP,GIF', '9999', '8000', '1', '33', 'RightBottom', '/uploads/logo/defualt/logo.png');
...
INSERT INTO `up_permission` VALUES ('3', '云组件中心', '1', '', '', '', '1', 'cloudcomponents', '', '');
...
-- ----------------------------
DROP TABLE IF EXISTS `up_plugins`;
CREATE TABLE `up_plugins` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `dir` varchar(255) NOT NULL COMMENT '目录',
  `pluginPath` varchar(255) NOT NULL COMMENT '路径',
  `name` varchar(255) NOT NULL COMMENT '插件名称',
  `info` text NOT NULL COMMENT '插件信息',
...
CREATE TABLE `up_role` (
  ...
  PRIMARY KEY (`rid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='角色表';
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='角色权限表';
...
CREATE TABLE `up_screengroup` (
  ...
  PRIMARY KEY (`sid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='屏幕分类';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='上传的3D模型';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='用户角色';
